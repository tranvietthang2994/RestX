...
namespace RestX.API.Services.Implementations
{
    public class FileService : BaseService, IFileService
    {
        ...
        {
            var file = await Repo.GetByIdAsync<Models.Entities.File>(fileId);
            if (file != null)
            {
                file.Name = name;
                file.Url = url;
        ...
        #endregion
        public async Task<Models.Entities.File> CreateFileFromUploadAsync(string filePath, string fileName, Guid ownerId)
        {
